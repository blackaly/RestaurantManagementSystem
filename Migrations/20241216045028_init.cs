        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvabilityStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MenuItems_Promotions_MenuItemsId",
                        column: x => x.MenuItemsId,
                        principalTable: "Promotions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MenuItems_Promotions_PromotionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItemPromotions", x => new { x.MenuItemsId, x.PromotionId });
                    table.ForeignKey(
                        name: "FK_MenuItemPromotions_MenuItems_MenuItemsId",
                        column: x => x.MenuItemsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    paymentCashFlowStatus = table.Column<int>(type: "int", nullable: false),
                    OrderId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_MenuItemsId",
                table: "MenuItems",
                column: "MenuItemsId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_PromotionId",
                table: "MenuItems",
                column: "PromotionId");
